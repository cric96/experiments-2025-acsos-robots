...
All the project dependencies are listed in the `gradle\libs.versions.toml` file,
and the project uses [Gradle](https://gradle.org) as a build tool.
...
The cluster used for the experiments has the following specifications:
