...
- _depotsBaseline_:  ```MAX_SEED=0 ./gradlew runDepotsBaselineGraphic```,
- _depotsBaselineRandomFailure_: ```MAX_SEED ./gradlew runDepotsBaselineRandomFailureGraphic```,
- _depotsOracle_: ```MAX_SEED ./gradlew runDepotsOracleGraphic```,
- _depotsOracleRandomFailure_: ```MAX_SEED ./gradlew runDepotsOracleRandomFailureGraphic```,
- _depotsRuntime_: ```MAX_SEED ./gradlew runDepotsRuntimeGraphic```,
- _depotsRuntimeRandomFailure_: ```MAX_SEED ./gradlew runDepotsRuntimeRandomFailureGraphic```.
