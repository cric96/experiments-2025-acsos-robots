...
open class EuclideanConfigurableMoveNode<T, P>(
    ...
    constructor(
        ...
        environment, node, routingStrategy, targetSelectionStrategy, GloballyConstantSpeed(reaction, speed)
    )
    ...
    override fun cloneAction(node: Node<T>, reaction: Reaction<T>): Action<T> =
        EuclideanConfigurableMoveNode(environment, node, routingStrategy, targetSelectionStrategy, speedSelectionStrategy)
}
